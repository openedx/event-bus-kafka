...
from edx_event_bus_kafka.consumer.management.commands.consume_events import Command
...
class TestConsumeEventCommand(TestCase):
    ...
    @patch('edx_event_bus_kafka.consumer.management.commands.consume_events.Command.create_consumer')
    ...
    @patch('edx_event_bus_kafka.consumer.management.commands.consume_events.Command.emit_signals_from_message')
