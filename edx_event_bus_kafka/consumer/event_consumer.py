...
class KafkaEventConsumer:
    """
    Constructs consumers for the given topic, group, and signal, and then
    emits signals.
    ...
    def create_consumer(self) -> DeserializingConsumer:
        """
        ...
        try:
            ...
            if signal != self.signal:
                logger.error(
                    ...
                    "Received message of type {signal.event_type}."
                )
                return
